									...
									<div class="row">
										...
										<div class="col-xl-6">
											<div class="submit-field">
												<h5>First Name</h5>
												<input type="text" class="with-border" ng-model="profile.first_name">
											</div>
										</div>
										...
										<div class="col-xl-6">
											<div class="submit-field">
												<h5>Last Name</h5>
												<input type="text" class="with-border" ng-model="profile.last_name">
											</div>
										</div>
										...
										<div class="col-xl-6">
											<div class="submit-field">
												<h5>Email</h5>
												<input type="text" class="with-border" ng-model="profile.email">
											</div>
										</div>
